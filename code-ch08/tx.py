...
class Tx:
    ...
    def verify_input(self, input_index):
        ...
        if Script.is_p2sh_script_pubkey(script_pubkey):
            ...
            redeem_script_length = len(redeem_script_bytes)
            redeem_script_bytes = encode_varint(redeem_script_length) + redeem_script_bytes
